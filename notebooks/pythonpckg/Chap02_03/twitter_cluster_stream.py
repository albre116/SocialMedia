# Chap02-03/twitter_cluster_stream.py
import sys
import json
...
def get_parser():
    ...
    parser.add_argument('--tweets-per-cluster', type=int, default=1)
...
if __name__ == '__main__':
    ...
    with open(args.filename) as f:
        ...
        # print 10 tweets description for this cluster
        for label, descriptions in clusters.items():
            print('---------- Cluster {}'.format(label))
            for desc in descriptions[:args.tweets_per_cluster]:
